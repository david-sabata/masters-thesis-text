...
\projectinfo{
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={vývoj her, mobilní zaøízení, Android, mechanika letu, dotykové ovládání}, %klicova slova v ceskem jazyce
  keywords.en={game development, mobile devices, Android, flight mechanics, touch input}, %klicova slova v anglickem jazyce
  %Abstract
  abstract.cs={Tato práce se zabývá vývojem letecké hry pro platformu Android. Nejdøíve budou popsány mo¾nosti nativního vývoje a~vývoje s vyu¾itím knihovny Libgdx. Dále budou vysvìtleny principy které se uplatòují pøi letu skuteèného letadla a tyto budou zjednodu¹eny pro pou¾ití v leteckých hrách. Práce také shrne souèasné trendy v ovládání leteckých her na mobilních zaøízeních a navrhne novou metodu zalo¾enou na dotykovém ovládání. V závìru bude popsán aktuální stav implementace.}, % abstrakt v ceskem jazyce
  abstract.en={This work deals with flight game development on Android platform. Firstly the possibilities of native development and development using Libgdx library will be discussed. Then flight mechanics of a real aircraft will be explained and simplified for the use in flight games. The work will also summarize current trends in mobile flight game controls and will propose a~new control method based on touch input. In the end the current state of implementation will be described.}, % abstrakt v anglickem jazyce
  %Prohlaseni
  declaration={Prohla¹uji, ¾e jsem tento semestrální projekt vypracoval samostatnì pod vedením\\ Doc.~Ing.~Adama~Herouta, Ph.D.},
