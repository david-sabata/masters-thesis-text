...
\begin{figure}[ht]
	\begin{center}
		...
		\caption{Rozlo¾ení verzí systému Android k~dubnu 2013}
		\label{fig:api-verze}
	\end{center}
\end{figure}
...
\begin{figure}[ht]
	\begin{center}
		...
		\caption{Souèásti rozhraní hlavního menu hry}
		\label{fig:ui-design}
	\end{center}
\end{figure}
...
\begin{figure}[ht]
	\begin{center}
		...
		\caption{Rozhraní nástroje Texture Packer a atlas textur pou¾itý ve høe}
		\label{fig:ui-atlas}
	\end{center}
\end{figure}
...
\begin{figure}[ht]
	\begin{center}
		...
		\caption{Screenshot hry Race Pilot ovládané pomocí sensorù. ©edé ètverce po stranách ovládají smìrové kormidlo, které je v¹ak implementováno nesprávnì; zdroj: Google Play}
		\label{fig:racepilot}
	\end{center}
\end{figure}
...
\note{TODO: opravit nìkteré diagramy}
...
\vspace{\baselineskip}
\note{TODO: diagram tøíd z hlediska herní logiky}
...
Po získání a zpracování zpìtné vazby byla hra publikována na internetový obchod Google Play pod názvem Air Racer. Tam se v dobì dokonèování této práce umístila na pozici 9. nejlep¹í bezplatné aplikace v kategorii závodních her a nainstalovalo si ji více ne¾ 50000 hráèù. Hra je kompatibilní s více ne¾ 94\% mobilních zaøízení platformy Android (dle døíve uvedených statistik).
