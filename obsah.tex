...
Tento text shrnul mo¾nosti vývoje 3D her na platformì Android s vyu¾itím knihovny Libgdx. Dále se vìnoval popisu letu skuteèného letadla a z~nìj vycházející zjednodu¹ené simulaci letu pou¾ívané ve hrách. Srovnává také existující metody ovládání leteckých her a navrhuje novou metodu, která záva¾nými nedostatky oproti ostatním netrpí. Navrhovaná metoda je zalo¾ená na dotykovém vstupu za pou¾ití dvou prstù a nabízí velmi rychlé a pøesné ovládání, èím¾ posiluje dojem, ¾e má hráè letadlo plnì pod kontrolou. Provedený prùzkum i reakce na výslednou implementaci ukazují, ¾e hráèi metodu hodnotí velmi pozitivnì.

Dále tato práce popsala návrh a implementaci hry, která toto ovládání vyu¾ívá. Jde o~hru kde hráè s~akrobatickým letadlem prolétává brankami a sna¾í se doletìt do cíle v~co nejkrat¹ím èase. Hra je navr¾ená tak, aby co nejvíce tì¾ila z~pøedstavené ovládací metody, podpoøila tak její my¹lenku a v~ideálním pøípadì i dal¹í roz¹íøení na poli mobilních leteckých her. V~prùbìhu vývoje vznikl prototyp hry, na kterém se ovìøily základní principy ovládání. Následnì vznikla plnohodnotná implementace hry s vyu¾itím právì knihovny Libgdx. Hra byla prùbì¾nì konzultována s firmou CUKETA, s.r.o., která se vývojem her profesionálnì zabývá, a pøed zveøejnìním hry probìhl také dotazníkový prùzkum. Po získání a zpracování zpìtné vazby byla hra publikována na internetový obchod Google Play pod názvem Air Racer. Tam se v dobì dokonèování této práce umístila na pozici 9. nejlep¹í bezplatné aplikace v kategorii závodních her a nainstalovalo si ji více ne¾ 50000 hráèù.

\note{TODO: pokrytí 99\% zaøízení?}
