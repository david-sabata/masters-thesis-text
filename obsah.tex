...
Aplikace pro systém Android lze distribuovat nìkolika rùznými cestami. Tou nejzákladnìj¹í je pøímá distribuce binární podoby aplikace (v souboru s pøíponou APK). Tato volba v¹ak znemno¾ní jakoukoliv dal¹í automatickou aktualizaci (manuální aktualizaci lze stále provést získáním nové verze souboru) a souèasnì nedovoluje mít kontrolu nad tím, kteøí u¾ivatelé, na jakých zaøízeních a za jakých podmínek, budou aplikaci pou¾ívat. Z tìchto dùvodù lze pøímou distribuci oznaèit za u¾ivatelsky nepøíli¹ pohodlnou. Své vyu¾ití v¹ak mù¾e nalézt u aplikací, které mají být spou¹tìny jen na nekolika málo kusech zaøízení. Pøíkladem takové situace mù¾e být testování prototypu aplikace a jeho kompatibility.
...
\note{OK r1; aktualizovat statistiky}
...
\note{TODO: aktualizovat statistiky}
...
Po získání a zpracování zpìtné vazby byla hra publikována na internetový obchod Google Play pod názvem Air Racer\footnote{\url{https://play.google.com/store/apps/details?id=cz.davidsabata.airracer}}. Tam se v dobì dokonèování této práce umístila na pozici 9. nejlep¹í bezplatné aplikace v kategorii závodních her a nainstalovalo si ji více ne¾ 50000 hráèù. Hra je kompatibilní s více ne¾ 94\% mobilních zaøízení platformy Android (dle døíve uvedených statistik).
