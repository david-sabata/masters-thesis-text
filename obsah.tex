...
Jak ji¾ bylo naznaèeno v popisu knihovny Libgdx v kapitole \ref{sec:libgdx}, jednou z jejích výhod je pøenositelnost mezi platformami. 
...
\note{- zmínit ¾e existuje i devscreen, ale v diagramu není}

\section{Herní logika}
\note{Herní mechanismy a jejich implementace}
\note{- fyzika - výkon znaènì klesá se slo¾itostí obalových tìles}
...
\note{- tutorial screen - odkazuje sem kapitola o prototypu}


\section{Vývojáøské rozhraní}
\note{- vlastní kapitola nebo podkapitola?}
\note{- proè je, kde je, co umí, obrázek}

\section{Zveøejnìní hry a zpìtná vazba}

\subsection{Veøejné testování a prùzkum}
\label{sec:verejne-testovani}
\note{odkazuje sem prototyp/ovladani} 
